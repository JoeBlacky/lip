...
var app = {
  ...
  initGridSlider : function() {
    var gridSlider = $('.grid-slider');

    if (gridSlider.length){
      gridSlider.owlCarousel({
        itemsCustom: [[960, 5], [650,4], [440,3],[0,2]]
      });
    }
  },
  detectPageScroll : function() {
  ...
  checkVisibility : function() {
    $('section:in-viewport').addClass('in-view');
  },
  ...
  scrollTo : function() {
    ...
    scrollButton.click(function(e){
      e.preventDefault();
      var headerHeight = $('.fake-header').outerHeight();
